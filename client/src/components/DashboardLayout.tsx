...
import { Calendar, Camera, Coffee, FileText, History, LayoutDashboard, LogOut, Megaphone, Monitor, PanelLeft, Settings, Shield, Sparkles, Star, Tag, UtensilsCrossed } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Shield, label: "Security Log", path: "/security" },
